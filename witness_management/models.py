...
class Witness(models.Model):
    ...
    witness_type = models.CharField(max_length=40, blank=True, null=True)
    mechanism = models.CharField(max_length=40, blank=True, null=True)    
    ...
    manager_assignee = models.CharField(max_length=60, blank=True, null=True)
    coordinator_department = models.CharField(max_length=60, blank=True, null=True)
    coordinator_assignee = models.CharField(max_length=60, blank=True, null=True)
